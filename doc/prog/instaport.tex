...
The NWChem source code tree current release is version 4.0.1.  To obtain NWChem
...
\\
 ...
 \\
   \verb+NWCHEM_BASIS_LIBRARY_PATH+ & location of the basis set library \\
                              & (the builder is responsible to make \\
                              & sure that the library gets to the \\
                              & place), e.g.\\
   \verb+ setenv NWCHEM_BASIS_LIBRARY_PATH "/bin/library"+\\
 \\
