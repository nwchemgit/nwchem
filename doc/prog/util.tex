...
\subsection{{\tt util\_print\_centered}}
\begin{verbatim}
...
\subsection{{\tt util\_char\_ga\_brdcst}}
\begin{verbatim}
...
\subsection{{\tt fcsnd} and {\tt fcrcv}}
\begin{verbatim}
...
\subsection{{\tt util\_file\_prefix}}
\begin{verbatim}
...
\section{Sequential Fortran files}

\subsection{{\tt util\_flush}}
\begin{verbatim}
...
\section{Parallel file operations}

\subsection{{\tt begin\_seq\_output}, {\tt write\_seq}, and {\tt end\_seq\_output}}
\begin{verbatim}
...
\subsection{Checksum C and Fortran interface}
...
\section{Source version information}

\subsection{{\tt util\_version}}
\begin{verbatim}
...
\section{Times and dates}

\subsection{{\tt util\_cpusec}}
\begin{verbatim}
...
\section{System operations and information}

\subsection{{\tt util\_hostname}}
\begin{verbatim}
...
\subsection{{\tt util\_file\_unlink}}
\begin{verbatim}
...
\section{C to Fortran interface}

\subsection{{\tt string\_to\_fortchar} and {\tt
...
\subsection{{\tt ieeetrap}}

\section{Miscellaneous BLAS-like operations}
...
\subsection{Initializing arrays --- {\tt dfill} and {\tt ifill}}
