%
% $Id: integral_api.tex,v 1.7 1998-10-01 05:15:37 windus Exp $
%
% 
%-----------------------------------------------------------------%  
%                                                                 % 
...
% 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%% NOTE: the chapter title is replaced by a section, and 'section'
%%%%%       headings are replaced by 'subsection', per new organization
%%%%%       of manual using template; must be changed in Ricky's source, if
%%%%%       this approach is adopted permanently.  (JMC)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
