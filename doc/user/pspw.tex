%
% $Id: pspw.tex,v 1.40 2004-05-19 22:45:04 bylaska Exp $
%
\label{sec:pspw}
...
in a simulation (Note - the Car-Parrinello code reconginizes Cartesian
...
\end{verbatim}
The implementation oif HGH pseudopotentials is rather limited in this release.
