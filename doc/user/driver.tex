...
The value specified for the integer \verb+<nptopt>+ defines the maximum 
...
The value specified for the integer \verb+modsad+ defines the type of
optimization to be performed, an energy minimization (\verb+<modsad> =
0+) or a transition state optimization (\verb+<modsad> = 1+).
