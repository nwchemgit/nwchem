...
\begin{itemize}
\time basic information to identify the geometry object in the code and
...
\begin{itemize}
\item \verb+c2v+ -- C\sub{2v}
\item \verb+d2h+ -- D\sub{2h}
\item \verb+Td+ -- T\sub{d}
\item \verb+d6h+ -- D\sub{6h}
\end{itemize}
