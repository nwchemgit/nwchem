...
\begin{verbatim}
  ...
  XC [[acm] [b3lyp] [beckehandh] [pbe0]\
     [becke97]  [becke97-1] [becke98] [hcth] [hcth120] [hcth147]\
      [h407] [becke97gga1] \
...
The {\tt \bf SMEAR} keyword is useful in case with many degenerate states
near the HOMO (eg metallic clusters)

\begin{verbatim}
  CONVERGENCE smear <real smear default 0.001>
\end{verbatim}

This  option allows fractional occupation of the molecular orbitals.
A Gaussian broadening function of exponent {\tt smear} is used as desribed in 
the paper:
