...
\begin{verbatim}
  GRID lebedev <integer radpts default 50> <integer iangquad default 8> 
\end{verbatim}
...
\end{verbatim}
Work is in progress to define pre-computed Lebedev quadrature of given accuracy
\begin{center}
\begin{tabular}[right]{|c|c|} \hline
Keyword & {\tt Total Energy Target Accuracy} \\ \hline
...
\begin{description}
\item[\tt euler] Murray Handy Laming, Euler-McLaurin \\
\item[\tt mura] M.E.Mura and P.J.Knowles, J Chem Phys {\bf 104}, 9848
(1996).\\
\item[\tt treutler] O.Treutler and R.Alrhichs, J.Chem.Phys {\bf 102}, 346 (1995).\\
