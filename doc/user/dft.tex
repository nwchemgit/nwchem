%
% $Id: dft.tex,v 1.89 2006-02-24 20:46:45 edo Exp $ 
%
\label{sec:dft}
...
\begin{verbatim}
  ...
  XC [[acm] [b3lyp] [beckehandh] [pbe0]\
     [becke97]  [becke97-1] [becke97-2] [becke97-3] [becke98] [hcth] [hcth120] [hcth147]\
      ...
      [b1b95] [bb1k] [mpw1b95] [mpwb1k] [pw6b95] [pwb6k] [m05] [m05-2x]\
...
\item Y. Zhao, N. E. Schultz and D. G. Truhlar, J. Chem. Theory Comput. in press (2006)
\end{enumerate}
}
%\end{table}
\onecolumn
