%
% $Id: dft.tex,v 1.76 2003-10-14 19:07:57 pollack Exp $ 
%
\label{sec:dft}
...
One way to compute Meta-GGA energies is self consistently, 
which we have implemented in the code, 
using the method outlined in 
R. Neumann, R.H. Nobes, and N.C. Handy, Mol.Phys.
{\bf 87}, 1 1996.

Another way to calculate meta-GGA energies is to use
