...
\item
\begin{verbatim}
update center <integer nfcntr> [zonly | xyonly] [fraction <integer idscb(1:5)>]
\end{verbatim}
...
previous \verb+record coord+, \verb+record wcoor+ and \verb+record scoor+
directives. 
...
takes precedent over \verb+record coord+. This directive redefines
previous \verb+record coord+, \verb+record wcoor+ and \verb+record scoor+
directives. 
The default is not to record.
...
previous \verb+record veloc+, \verb+record wvelo+ and \verb+record svelo+
directives. 
The default is not to record.
...
takes precedent over \verb+record veloc+. This directive redefines
previous \verb+record veloc+, \verb+record wvelo+ and \verb+record svelo+
directives. 
The default is not to record.
...
x, y and z dimension respectively, and \verb+<np>+ is the number of processors
