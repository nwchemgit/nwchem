...
name of your input file. 
If you use WMPI, uou must have a file named {\bf \tt nw32.pg} in the
...
of them.
\item Linux on Alpha cpus has been tested with RedHat 6.1 and 6.2.
...
\item HP 9000/800 workstations with  HPUX B.11.00. f90 must be used for
    compilation.
%  The Linux Alpha version 5.2 from Red Hat fails to compile
%.the code as well as the beta release of the Digital Fortran compiler
%or Linux based Alpha systems.  
...
\item  Intel x86 with Windows 98 and NT has been tested with Compaq Visual
Fortran 6.0 and 6.1 with WMPI 1.3 or NT-MPICH. NT-MPICH is available from
