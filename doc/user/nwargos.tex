...
\begin{verbatim}
cg <i mcgit> [init <r dx0cg>] [min <r dxcgmx>] [max <r dxmcg>] [cy <i ncgcy>]
\end{verbatim}
...
the follwing keywords. Fixing part of the system will propagate to
...
\begin{itemize}
\item 
The calculation of the autocorrelation is controled with the keywords
\begin{verbatim}
