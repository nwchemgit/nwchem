...
It is possible to alter the charge of the atomic guess with set
directives (c.g., \ref{sec:set}.  The input is as follows:

\begin{verbatim}
set atomscf:num_z integer <integer num_z >
set atomscf:z     real    <real list of charges >
...
of them).  There are limits to this procedure.  You cannot add
electrons to closed shell atoms and you cannot remove all electrons
from a given atom.  The sofware will error and quit reporting problems
with modifying the charge if they are detected.
