...
\begin{verbatim}
repeat <integer nx> <integer ny> <integer nz> <real dist>
\end{verbatim}
...
the z-direction, with a minimum distance of \verb+dist+ bewtween any
pair of atoms from different copies. This directive should only be
used for system without solvent.
