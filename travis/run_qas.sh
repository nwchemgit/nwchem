...
# source env. variables
 ...
 if [[ "$NWCHEM_MODULES" == "tce" ]]; then
   ...
   diff $NWCHEM_TOP/QA/testoutputs/tce_h2o_eomcc.out.nwparse $NWCHEM_TOP/QA/testoutputs/tce_h2o_eomcc.out.nwparse
   cd $NWCHEM_TOP/QA && ./runtests.mpi.unix procs 2 tce_ipccsd_f2
   echo "diff output for tce_ipccsd_f2"
   diff $NWCHEM_TOP/QA/testoutputs/tce_ipccsd_f2.out.nwparse $NWCHEM_TOP/QA/testoutputs/tce_ipccsd_f2.out.nwparse
 else
