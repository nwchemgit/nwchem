...
md5sum nwchem-"${NWVER}".revision-"${REV68}"-src.`date +%Y-%m-%d`.tar.gz > nwchem-6.8.revision"${REV68}"-src.`date +%Y-%m-%d`.tar.gz.md5
tar --exclude=".git" -cjvf nwchem-"${NWVER}".revision-"${REV68}"-src.`date +%Y-%m-%d`.tar.bz2 nwchem-6.8/*
md5sum nwchem-"${NWVER}".revision-"${REV68}"-src.`date +%Y-%m-%d`.tar.bz2 >  nwchem-6.8.revision"${REV68}"-src.`date +%Y-%m-%d`.tar.bz2.md5
tar --exclude=".git" -cjvf nwchem-"${NWVER}".revision-"${REV68}"-srconly.`date +%Y-%m-%d`.tar.bz2 nwchem-6.8/src/*
md5sum nwchem-"${NWVER}".revision-"${REV68}"-srconly.`date +%Y-%m-%d`.tar.bz2>  nwchem-6.8.revision"${REV68}"-srconly.`date +%Y-%m-%d`.tar.bz2.md5
tar --exclude=".git" --exclude="src" -cjvf nwchem-"${NWVER}".revision-"${REV68}"-nonsrconly.`date +%Y-%m-%d`.tar.bz2 nwchem-6.8/*
md5sum nwchem-"${NWVER}".revision-"${REV68}"-nonsrconly.`date +%Y-%m-%d`.tar.bz2 > nwchem-6.8.revision"${REV68}"-nonsrconly.`date +%Y-%m-%d`.tar.bz2.md5
