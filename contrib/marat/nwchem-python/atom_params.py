...
class AtomParams():
    ...
    @staticmethod 
    def fullName(s):
        return AtomParams.genProperty(s, AtomParams.__fulename)[0]
    
    @staticmethod 
    def elementName(s):
        return AtomParams.genProperty(s, AtomParams.__fulename)[1]
    
    @staticmethod 
    def vdwRadius(s):
        return AtomParams.genProperty(s, AtomParams.__vdw)[0]
    
    @staticmethod 
    def covRadius(s):
        return AtomParams.genProperty(s, AtomParams.__rc)[0]
    
    @staticmethod 
    def weight(s):
        return AtomParams.genProperty(s, AtomParams.__weight)[0]
