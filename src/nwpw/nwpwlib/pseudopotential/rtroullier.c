...
void	Suggested_Param_RelTroullier(int *num_states_psp,
int *n_psp,int *l_psp, int *s_psp, double *e_psp,
...
void	solve_RelTroullier(int num_psp,
int *n_psp,
int *l_psp,
int *s_psp,
double *e_psp,
...

{
    ...
    *Vl;
	...
	l=l_psp[p];
        ...
        /**************************************/
        /* generate relativistic troullier pseudopotential */
        /**************************************/
        init_xpansion(l,match,fill_psp[p],el,Vall,ul,ul_prime,Vl,wl,wl_prime);
        psi_xpansion();
        dpsi_xpansion();
        psp_xpansion();
