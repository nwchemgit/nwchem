...
*                    d(n*xce)/d|grad n|
      ...
      subroutine gen_PBEsol_BW_unrestricted(n2ft3d,
     >                           dn_in,agr_in,
...
c     ***** PBEsol GGA exchange constants ******
      real*8 MU,KAPPA
      parameter (MU    = (10.0d0/81.0d0))
      parameter (KAPPA = 0.8040000000000000d0)
 
c     ****** PBEsol GGA correlation constants ******
...
c        ********************************************
c        **** calculate PBEsol correlation energy ****
c        ********************************************
         phi3 = phi**3
         phi4 = phi3*phi
...
*
      subroutine gen_PBEsol_BW_restricted(n2ft3d,rho_in,agr_in,
     >                                x_parameter,c_parameter,
     >                                xce,fn,fdn)
      implicit none
...
c        **** PBEsol correlation energy  corrections ****
         t2 = t*t
         t4 = t2*t2
         B = -ec_lda/GAMMA
...
c        **** PBEsol correlation fdn and fdnc derivatives ****
         t6   = t4*t2
