...
*    This function returns the M06 exchange-correlation
...
*
*     Exit  - xce(n2ft3d) : M06 exchange correlation energy density
*             fn(n2ft3d)  : d(n*xce)/dn
*             fdn(n2ft3d) : d(n*xce)/d|grad n|
*             fdtau(n2ft3d) : d(n*xce)/dtau
*

      subroutine gen_M06_restricted(n2ft3d,rho_in,agr_in,tau_in,
...
*     ***** VS98 constants *****
      ...
      parameter (aax =  1.422057d-1*(-0.9305257363491))
      parameter (bbx =  7.370319d-4*(-0.9305257363491))
      parameter (ccx = -1.601373d-2*(-0.9305257363491))
      parameter (ddx =   0.000000d0)
      parameter (eex =   0.000000d0)
      parameter (ffx =   0.000000d0)
      parameter (aass =  4.905945d-1)
      parameter (bbss = -1.437348d-1)
      parameter (ccss =  2.357824d-1)
      parameter (ddss =  1.871015d-3)
      parameter (eess = -3.788963d-3)
      parameter (ffss =  0.000000d0)
      parameter (aaopp = -2.741539d0)
      parameter (bbopp = -6.720113d-1)
      parameter (ccopp = -7.932688d-2)
      parameter (ddopp =  1.918681d-3)
      parameter (eeopp = -2.032902d-3)
...
c     cf = 3.0d0/5.0d0*(6.0d0*pi*pi)**(2.0d0/3.0d0))
      parameter (ma0  =  5.877943d-1)
      parameter (ma1  = -1.371776d-1)
      parameter (ma2  =  2.682367d-1)
      parameter (ma3  = -2.515898d0)
      parameter (ma4  = -2.978892d0)
      parameter (ma5  =  8.710679d0)
      parameter (ma6  =  1.688195d1)
      parameter (ma7  = -4.489724d0)
      parameter (ma8  = -3.299983d1)
      parameter (ma9  = -1.449050d1)
      parameter (ma10 =  2.043747d1)
      parameter (ma11 =  1.256504d1)
      parameter (C1   =  3.36116d-3)
      parameter (C2   =  4.49267d-3)
      parameter (css = 0.06d0)
      parameter (ccss0 =  5.094055d-1)
      parameter (ccss1 =  -1.491085d0)
      parameter (ccss2 =  1.723922d1)
      parameter (ccss3 =  -3.859018d1)
      parameter (ccss4 =  2.845044d1)
      parameter (copp = 0.0031d0)
      parameter (ccopp0 = 3.741539d0)
      parameter (ccopp1 = 2.187098d2)
      parameter (ccopp2 = -4.531252d2)
      parameter (ccopp3 = 2.936479d2)
      parameter (ccopp4 = -6.287470d1)
      

      Cx = -1.50d0*(0.75d0/pi)**thrd
      P23 = 0.60d0*(6.0d0*pi*pi)**twthrd
c     Cs = 0.5d0/(3.0d0*pi*pi)**twthrd
...
*
      subroutine gen_M06_unrestricted(n2ft3d,rho_in,agr_in,tau_in,
     >                               x_parameter,c_parameter,
     >                               xce,fn,fdn,fdtau)
      implicit none
*     ***** input *****
