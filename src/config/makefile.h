...
ifeq ($(GOTMINGW64),1)
   ...
   ifeq ($(FC),g77)
     ...
     ifeq ($(FC),$(findstring $(FC),gfortran gfortran-4 gfortran-5 gfortran6 gfortran-6 gfortran-7 gfortran7 gfortran-8 gfortran8 gfortran-9 gfortran9 gfortran-10 gfortran10 gfortran-11 gfortran11 gfortran-12 gfortran12 i686-w64-mingw32.static-gfortran x86_64-w64-mingw32-gfortran-win32))
       _FC= gfortran
     endif
     ifeq ($(CC),$(findstring $(CC),gcc gcc-4 gcc-5 gcc6 gcc-6 gcc-7 gcc7 gcc-8 gcc8 gcc-9 gcc9 gcc-10 gcc10 gcc-11 gcc11 gcc-12 gcc12 i686-w64-mingw32.static-gcc x86_64-w64-mingw32-gcc-win32))
     ifneq ($(CC),cc)
       _CC= gcc
     endif
     endif
