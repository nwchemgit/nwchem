# $Id: nwchem_config_win32.h,v 1.21 2003-02-06 21:29:17 edo Exp $
...
NW_MODULE_SUBDIRS = NWints atomscf ddscf gradients moints nwdft rimp2 stepper driver dftgrad cphf ccsd vib mcscf prepar  esp hessian selci dplot mp2_grad property nwpw fft nbo analyz nwmd cafe space drdy qmmm qmd  etrans tce tddft $(PYTHON_SUBDIR)
