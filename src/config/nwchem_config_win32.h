# $Id: nwchem_config_win32.h,v 1.10 2000-11-25 02:42:14 bjohnson Exp $
...
NW_MODULE_SUBDIRS = NWints atomscf ddscf gradients moints nwdft rimp2 stepper driver dftgrad cphf ccsd vib mcscf prepar nwargos esp hessian selci dplot mp2_grad property fft nbo analyz nwmd cafe space drdy qmmm qmd $(PYTHON_SUBDIR)
