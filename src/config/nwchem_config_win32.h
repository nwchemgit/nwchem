# $Id: nwchem_config_win32.h,v 1.15 2001-08-28 01:01:21 edo Exp $
...
NW_MODULE_SUBDIRS = NWints atomscf ddscf gradients moints nwdft rimp2 stepper driver dftgrad cphf ccsd vib mcscf prepar  esp hessian selci dplot mp2_grad property pspw fft nbo analyz nwmd cafe space drdy qmmm qmd mcstep $(PYTHON_SUBDIR)
