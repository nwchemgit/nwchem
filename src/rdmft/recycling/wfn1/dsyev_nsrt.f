...
*  ===========
*
*       SUBROUTINE DSYEV_NSRT( JOBZ, UPLO, N, A, LDA, W, WORK, LWORK, INFO )
* 
*       .. Scalar Arguments ..
*       CHARACTER          JOBZ, UPLO
...
*>          If INFO = 0, the eigenvalues but not sorted
*> \endverbatim
*>
*> \param[out] WORK
*> \verbatim
...
*
*  =====================================================================
      SUBROUTINE DSYEV_NSRT( JOBZ, UPLO, N, A, LDA, W, WORK, LWORK,
     +                       INFO )
*
...
*
      IF( .NOT.WANTZ ) THEN
         CALL DSTERF_NSRT( N, W, WORK( INDE ), INFO )
      ELSE
         CALL DORGTR( UPLO, N, A, LDA, WORK( INDTAU ), WORK( INDWRK ),
     $                LLWORK, IINFO )
         CALL DSTEQR_NSRT( JOBZ, N, W, WORK( INDE ), A, LDA,
     $                     WORK( INDTAU ), INFO )
      END IF
*
