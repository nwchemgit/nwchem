c
c $Id: md_frce.f,v 1.1 2008-10-01 22:32:28 marat Exp $
c
...
c Bonded interactions
      if(ntbond.gt.0)call frce_bond(ntbond,ebond)

c Core-shell interactions
      if(ntshel.gt.0)call frce_shel(ntshel,eshel)

      do i=1,natms
        write(68,*) i, fff(i,1),fff(i,2),fff(i,3)
      end do
