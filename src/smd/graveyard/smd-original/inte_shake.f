...
c       write(31,*) fff(i,1),vvv(i,1),ccc(i,1)
      ...
      do i=1,maxit
       ...
       enddo
       write(51,*) i,nrij(1,1), nrij(1,2),nrij(1,3)
...
100   continue
      ...
      do i=1,natms
       ...
       vvv(i,2)=nvv(i,2)
       vvv(i,3)=nvv(i,3)
       write(31,*) fff(i,1),vvv(i,1),ncc(i,1)
