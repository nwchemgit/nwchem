      ...
      double complex eikr(mxatms)
      double complex eikx(1:mxatms,       0:mxkvect)
      double complex eiky(1:mxatms,-mxkvect:mxkvect)
      double complex eikz(1:mxatms,-mxkvect:mxkvect)
     ...
     $            dimag(rhosum*dconjg(eikr(i)))*typchge(iatm)
